export const BancorConverterRegistry = [
  ...
  {
    constant: true,
    inputs: [{ name: '_convertibleToken', type: 'address' }, { name: '_value', type: 'address' }],
  ...
  {
    constant: true,
    inputs: [{ name: '_reserveTokens', type: 'address[]' }, { name: '_reserveRatios', type: 'uint256[]' }],
  ...
  {
    constant: true,
    inputs: [{ name: '_convertibleToken', type: 'address' }, { name: '_index', type: 'uint256' }],
