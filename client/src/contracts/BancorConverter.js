export const BancorConverter = [
  ...
  {
    constant: true,
    inputs: [{ name: '_amount', type: 'uint256' }, { name: '_magnitude', type: 'uint8' }],
    name: 'getFinalAmount',
    outputs: [{ name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
  ...
  {
    constant: false,
    inputs: [{ name: '_token', type: 'address' }, { name: '_weight', type: 'uint32' }, { name: '', type: 'bool' }],
    name: 'addConnector',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ name: '_token', type: 'address' }, { name: '_ratio', type: 'uint32' }],
    name: 'addReserve',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: true,
    inputs: [{ name: '_reserveToken', type: 'address' }, { name: '_sellAmount', type: 'uint256' }],
    name: 'getSaleReturn',
    outputs: [{ name: '', type: 'uint256' }, { name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
  ...
  {
    constant: false,
    inputs: [{ name: '_reserveToken', type: 'address' }, { name: '_virtualBalance', type: 'uint256' }],
  ...
  {
    constant: false,
    inputs: [{ name: '_connectorToken', type: 'address' }, { name: '_disable', type: 'bool' }],
  ...
  {
    constant: true,
    inputs: [{ name: '_reserveToken', type: 'address' }, { name: '_depositAmount', type: 'uint256' }],
  ...
  {
    constant: false,
    inputs: [{ name: '_reserveToken', type: 'address' }, { name: '_disable', type: 'bool' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: '_prevFee', type: 'uint32' }, { indexed: false, name: '_newFee', type: 'uint32' }],
