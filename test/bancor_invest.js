...
describe('BancorInvest', function () {
  ...
  it("should have emit Approval", async () => {
    let approve = await bancor_invest.approve("0xF5fe6280db283ba6975d72A3bD39bF57840433F7", "1000000000000000000");
  ...
  it('should be able to fund', async () => {
    let fund = await bancor_invest.fund("1000000000000000000");
